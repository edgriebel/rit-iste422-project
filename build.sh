...
javac -classpath .:lib/junit-4.12.jar:lib/hamcrest-core-1.3.jar src/java/*.java test/java/*.java
if [ $? -ne 0 ] ; then echo BUILD FAILED!; exit 1; fi

echo "Running unit tests..."
java -cp .:lib/junit-4.12.jar:lib/hamcrest-core-1.3.jar org.junit.runner.JUnitCore test/java/EdgeConnectorTest.java
