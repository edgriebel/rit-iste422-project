...
public class EdgeField {
	...
	public static Logger timeLogger = LogManager.getLogger("timer." + EdgeField.class.getName());

	public EdgeField(String inputString) {

		timeLogger.info("Called Constructor.");
		logger.debug(String.format("Constructor called with string: %s", inputString));
		...
		logger.debug(String.format("numFigure value currently: %d", numFigure));
		logger.debug(String.format("Current token: %s", name));
		timeLogger.info("Ended constructor");
	}
	...
	public String toString() {
		return numFigure + EdgeConvertFileParser.DELIM + name + EdgeConvertFileParser.DELIM + tableID
				+ EdgeConvertFileParser.DELIM + tableBound + EdgeConvertFileParser.DELIM + fieldBound
				+ EdgeConvertFileParser.DELIM + dataType + EdgeConvertFileParser.DELIM + varcharValue
				+ EdgeConvertFileParser.DELIM + isPrimaryKey + EdgeConvertFileParser.DELIM + disallowNull
				+ EdgeConvertFileParser.DELIM + defaultValue;
	}
}
